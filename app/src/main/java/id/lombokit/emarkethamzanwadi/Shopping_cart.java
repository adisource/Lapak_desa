...
public class Shopping_cart extends AppCompatActivity {
    ...
    String url_cart = "http://192.168.43.153/e_comm_covid/cart_count.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        judul.setText((CharSequence) "Cart");
    ...
    private void countCart() {
        StringRequest stringRequest1 = new StringRequest(Request.Method.POST, url_cart, new Response.Listener<String>() {
            @Override
